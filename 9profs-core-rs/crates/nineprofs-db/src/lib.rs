...
//!
//! Migrations 0002–0010 own assistants, agent metadata, MCP configuration, and
//! persistent research evidence/provenance/retrieval/manuscript citation sync state.
