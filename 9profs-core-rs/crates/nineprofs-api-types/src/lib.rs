...
pub use research::{
    ...
    CreateManuscriptClaimInventoryRequest, CreateManuscriptCrossClaimCandidatesRequest,
    CreateManuscriptReferenceCatalogRequest, CreateResearchCaseRequest, CreateResearchClaimRequest,
    CreateResearchEvidenceRequest, CreateResearchSourceRequest,
    ...
    ManuscriptCrossClaimCandidateDto, ManuscriptCrossClaimCandidateKindDto,
    ManuscriptCrossClaimCandidateRunDto, ManuscriptCrossClaimCandidateRunStatusDto,
    ManuscriptCrossClaimComparisonWindowDto, ManuscriptCrossClaimComparisonWindowStatusDto,
