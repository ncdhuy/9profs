...
pub use model::{
    ...
    REFERENCE_RESOLVER_POLICY_VERSION, ResearchArtifact, ResearchCase, ResearchCaseId,
    ...
    ResearchRetrievalScope, ResearchSource, ResearchSourceId, ResearchSourceIdentity,
    ResearchSourceIdentityInput, ResearchSourceIdentityMethod, ResearchSourceSnapshot,
    ResearchSourceSnapshotId, SafeMetadata, SourceKind, SourceOrigin,
    StartManuscriptClaimInventory, SyncManuscriptCitations, SyncManuscriptReferenceCatalog,
