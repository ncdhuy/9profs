...
impl_delegating_repository! {
    ...
    find_completed_manuscript_claim_inventory(research_case_id: &ResearchCaseId, manuscript_source_id: &ResearchSourceId, document_id: &str, document_version: i64, document_context_hash: &ContentHash, extractor_provider: &str, extractor_version: &str, extractor_model_id: Option<&str>, extraction_contract_version: &str, coverage_contract_version: &str) -> Result<Option<ManuscriptClaimInventoryRun>, ResearchError>;
